...
export const metadata: Metadata = {
  title: "Exchange Policy - MDFK CLOTHING CO.",
  description: "Read our size exchange policy. We offer exchanges for size issues within 5 days of delivery. No returns or refunds.",
};
