        ...
        <div className="container mx-auto px-4 py-8 max-w-7xl">
            ...
            <AnimatePresence mode="wait">
                {selectedItem ? (
                    ...
                    <motion.div
                        className="grid grid-flow-dense grid-cols-1 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-4 auto-rows-[200px]"
                        initial="hidden"
                        animate="visible"
                        exit="hidden"
                        variants={{
                    ...
                    >
                        {items.map((item, index) => (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-3xl cursor-move shadow-sm border border-brand-charcoal/5 group ${item.span}`}
                            ...
                            >
                                ...
                                />
                                <motion.div
                                    className="absolute inset-0 flex flex-col justify-end p-2 sm:p-4 md:p-6"
                                    initial={{ opacity: 0 }}
                                ...
                                >
                                    <div className="absolute inset-0 flex flex-col justify-end p-4 md:p-6">
                                        ...
                                        <h3 className="relative text-brand-bg text-lg sm:text-xl font-semibold font-serif line-clamp-1 mb-1">
                                            {item.title}
                                        </h3>
                                        <p className="relative text-brand-bg/80 text-xs sm:text-sm tracking-wide font-light line-clamp-2">
                                            {item.desc}
                                        </p>
                                    </div>
                                </motion.div>
